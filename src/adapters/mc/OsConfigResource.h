...
typedef struct _OsConfigResource /* extends OMI_BaseResource */
{
    ...
    MI_ConstStringField RulesObjectName;
    MI_ConstStringField RulesObjectValue;
...
MI_INLINE MI_Result MI_CALL OsConfigResource_Set_RulesObjectName(
    OsConfigResource* self,
    const MI_Char* str)
{
    return self->__instance.ft->SetElementAt(
...
MI_INLINE MI_Result MI_CALL OsConfigResource_SetPtr_RulesObjectName(
    OsConfigResource* self,
    const MI_Char* str)
{
    return self->__instance.ft->SetElementAt(
...
MI_INLINE MI_Result MI_CALL OsConfigResource_Clear_RulesObjectName(
    OsConfigResource* self)
{
    return self->__instance.ft->ClearElementAt(
        (MI_Instance*)&self->__instance,
...
MI_INLINE MI_Result MI_CALL OsConfigResource_Set_RulesObjectValue(
    OsConfigResource* self,
    const MI_Char* str)
{
    return self->__instance.ft->SetElementAt(
...
MI_INLINE MI_Result MI_CALL OsConfigResource_SetPtr_RulesObjectValue(
    OsConfigResource* self,
    const MI_Char* str)
{
    return self->__instance.ft->SetElementAt(
...
MI_INLINE MI_Result MI_CALL OsConfigResource_Clear_RulesObjectValue(
    OsConfigResource* self)
{
    return self->__instance.ft->ClearElementAt(
        (MI_Instance*)&self->__instance,

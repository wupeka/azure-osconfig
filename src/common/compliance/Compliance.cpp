...
int ComplianceExecuteRemediation(const JSON_Object* rule, std::map<std::string, std::string> parameters, void* log) {
    std::ostringstream logstream;
    ...
    OsConfigLogInfo(log, "ComplianceExecuteSetRule(%p) completed, result log '%s'", rule, logstream.str().c_str());
    return 0;
};
